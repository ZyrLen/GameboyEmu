...
void initCBOpcodeTable(Gameboy *gb) {
  ...
  CBopcodeTable[0x40] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit
    = 0, .isHL = 0}, .mnemonic = "BIT 0,B"};
  CBopcodeTable[0x41] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 0, .isHL = 0}, .mnemonic = "BIT 0,C"};
  CBopcodeTable[0x42] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 0, .isHL = 0}, .mnemonic = "BIT 0,D"};
  CBopcodeTable[0x43] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 0, .isHL = 0}, .mnemonic = "BIT 0,E"};
  CBopcodeTable[0x44] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 0, .isHL = 0}, .mnemonic = "BIT 0,H"};
  CBopcodeTable[0x45] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit
    = 0, .isHL = 0}, .mnemonic = "BIT 0,L"};
  CBopcodeTable[0x46] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 0, .isHL = 1}, .mnemonic = "BIT 0,(HL)"};
  CBopcodeTable[0x47] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit = 0, .isHL = 0}, .mnemonic = "BIT 0,A"};
  CBopcodeTable[0x48] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,B"};
  CBopcodeTable[0x49] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,C"};
  CBopcodeTable[0x4A] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,D"};
  CBopcodeTable[0x4B] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,E"};
  CBopcodeTable[0x4C] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,H"};
  CBopcodeTable[0x4D] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit = 1, .isHL = 0}, .mnemonic = "BIT 1,L"};
  CBopcodeTable[0x4E] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 1, .isHL = 1}, .mnemonic = "BIT 1,(HL)"};
  CBopcodeTable[0x4F] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit
    = 1, .isHL = 0}, .mnemonic = "BIT 1,A"};

  CBopcodeTable[0x50] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit
    = 2, .isHL = 0}, .mnemonic = "BIT 2,B"};
  CBopcodeTable[0x51] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 2, .isHL = 0}, .mnemonic = "BIT 2,C"};
  CBopcodeTable[0x52] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 2, .isHL = 0}, .mnemonic = "BIT 2,D"};
  CBopcodeTable[0x53] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 2, .isHL = 0}, .mnemonic = "BIT 2,E"};
  CBopcodeTable[0x54] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 2, .isHL = 0}, .mnemonic = "BIT 2,H"};
  CBopcodeTable[0x55] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit
    = 2, .isHL = 0}, .mnemonic = "BIT 2,L"};
  CBopcodeTable[0x56] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 2, .isHL = 1}, .mnemonic = "BIT 2,(HL)"};
  CBopcodeTable[0x57] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit = 2, .isHL = 0}, .mnemonic = "BIT 2,A"};
  CBopcodeTable[0x58] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,B"};
  CBopcodeTable[0x59] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,C"};
  CBopcodeTable[0x5A] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,D"};
  CBopcodeTable[0x5B] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,E"};
  CBopcodeTable[0x5C] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,H"};
  CBopcodeTable[0x5D] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit = 3, .isHL = 0}, .mnemonic = "BIT 3,L"};
  CBopcodeTable[0x5E] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 3, .isHL = 1}, .mnemonic = "BIT 3,(HL)"};
  CBopcodeTable[0x5F] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit
    = 3, .isHL = 0}, .mnemonic = "BIT 3,A"};

  CBopcodeTable[0x60] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit
    = 4, .isHL = 0}, .mnemonic = "BIT 4,B"};
  CBopcodeTable[0x61] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 4, .isHL = 0}, .mnemonic = "BIT 4,C"};
  CBopcodeTable[0x62] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 4, .isHL = 0}, .mnemonic = "BIT 4,D"};
  CBopcodeTable[0x63] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 4, .isHL = 0}, .mnemonic = "BIT 4,E"};
  CBopcodeTable[0x64] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 4, .isHL = 0}, .mnemonic = "BIT 4,H"};
  CBopcodeTable[0x65] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit
    = 4, .isHL = 0}, .mnemonic = "BIT 4,L"};
  CBopcodeTable[0x66] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 4, .isHL = 1}, .mnemonic = "BIT 4,(HL)"};
  CBopcodeTable[0x67] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit = 4, .isHL = 0}, .mnemonic = "BIT 4,A"};
  CBopcodeTable[0x68] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,B"};
  CBopcodeTable[0x69] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,C"};
  CBopcodeTable[0x6A] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,D"};
  CBopcodeTable[0x6B] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,E"};
  CBopcodeTable[0x6C] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,H"};
  CBopcodeTable[0x6D] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit = 5, .isHL = 0}, .mnemonic = "BIT 5,L"};
  CBopcodeTable[0x6E] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 5, .isHL = 1}, .mnemonic = "BIT 5,(HL)"};
  CBopcodeTable[0x6F] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit
    = 5, .isHL = 0}, .mnemonic = "BIT 5,A"};

  CBopcodeTable[0x70] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit
    = 6, .isHL = 0}, .mnemonic = "BIT 6,B"};
  CBopcodeTable[0x71] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 6, .isHL = 0}, .mnemonic = "BIT 6,C"};
  CBopcodeTable[0x72] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 6, .isHL = 0}, .mnemonic = "BIT 6,D"};
  CBopcodeTable[0x73] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 6, .isHL = 0}, .mnemonic = "BIT 6,E"};
  CBopcodeTable[0x74] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 6, .isHL = 0}, .mnemonic = "BIT 6,H"};
  CBopcodeTable[0x75] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit
    = 6, .isHL = 0}, .mnemonic = "BIT 6,L"};
  CBopcodeTable[0x76] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 6, .isHL = 1}, .mnemonic = "BIT 6,(HL)"};
  CBopcodeTable[0x77] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit = 6, .isHL = 0}, .mnemonic = "BIT 6,A"};
  CBopcodeTable[0x78] = (OE){.handler = BIT_R, .arg = &gb->B,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,B"};
  CBopcodeTable[0x79] = (OE){.handler = BIT_R, .arg = &gb->C,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,C"};
  CBopcodeTable[0x7A] = (OE){.handler = BIT_R, .arg = &gb->D,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,D"};
  CBopcodeTable[0x7B] = (OE){.handler = BIT_R, .arg = &gb->E,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,E"};
  CBopcodeTable[0x7C] = (OE){.handler = BIT_R, .arg = &gb->H,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,H"};
  CBopcodeTable[0x7D] = (OE){.handler = BIT_R, .arg = &gb->L,  .BitArgs = {.nbit = 7, .isHL = 0}, .mnemonic = "BIT 7,L"};
  CBopcodeTable[0x7E] = (OE){.handler = BIT_R, .arg = &gb->HL, .BitArgs = {.nbit
    = 7, .isHL = 1}, .mnemonic = "BIT 7,(HL)"};
  CBopcodeTable[0x7F] = (OE){.handler = BIT_R, .arg = &gb->A,  .BitArgs = {.nbit
    = 7, .isHL = 0}, .mnemonic = "BIT 7,A"};


  // , .mcycles = 2, .mnemonic = "RES 6,B"}
  // , .mcycles = 2, .mnemonic = "RES 6,C"}
  // , .mcycles = 2, .mnemonic = "RES 6,D"}
  // , .mcycles = 2, .mnemonic = "RES 6,E"}
  // , .mcycles = 2, .mnemonic = "RES 6,H"}
  // , .mcycles = 2, .mnemonic = "RES 6,L"}
  // , .mcycles = 4, .mnemonic = "RES 6,(HL)"}
  // , .mcycles = 2, .mnemonic = "RES 6,A"}
  // , .mcycles = 2, .mnemonic = "RES 7,B"}
  // , .mcycles = 2, .mnemonic = "RES 7,C"}
  // , .mcycles = 2, .mnemonic = "RES 7,D"}
  // , .mcycles = 2, .mnemonic = "RES 7,E"}
  // , .mcycles = 2, .mnemonic = "RES 7,H"}
  // , .mcycles = 2, .mnemonic = "RES 7,L"}
  // , .mcycles = 4, .mnemonic = "RES 7,(HL)"}
  // , .mcycles = 2, .mnemonic = "RES 7,A"}
